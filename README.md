...
# 📖 Public_IP_Finder_App <a name="about-project"></a>

A web app that displays a users IP address to them along with a map showing where they are located. We use react to create the web page and the google maps static API to fetch an image showing where the user is located.

## 🛠 Built With <a name="built-with"></a>

### HTML and CSS <a name="HTML and Css"></a>
### React and Vite <a name="HTML and Css"></a>
...
This is one of my first big project in CyberSecurity
